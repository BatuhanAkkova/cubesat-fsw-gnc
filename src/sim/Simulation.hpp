...
public:
    ...
    common::Vector3 getAngularRate() const { return body_->getAngularVelocity(); }
    common::Vector3 getPosition() const { return orbit_->getPosition(); }
    
    // For fault injection
    models::SimGyro& getGyro() { return *gyro_; }
    models::SimMagnetometer& getMag() { return *mag_; }
    models::SimStarTracker& getStarTracker() { return *st_; }
