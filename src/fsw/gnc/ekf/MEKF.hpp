...
public:
     ...
     */
    common::Quaternion getAttitude() const override { return q_est_; }
    common::Vector3 getAngularVelocity() const override { return w_est_; }
    bool isValid() const override { return !P_.array().isNaN().any(); }
