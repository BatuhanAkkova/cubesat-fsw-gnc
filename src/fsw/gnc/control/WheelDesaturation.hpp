...
public:
     ...
     */
    common::Vector3 update(const std::vector<std::shared_ptr<hal::IRW>>& wheels,
     ...
     */
    double getTotalMomentum() const { return total_momentum_; }

    /**
     * @brief Get maximum allowable momentum
     * @return Max momentum [Nms]
     */
    double getMaxMomentum() const { return max_momentum_; }
...
private:
     ...
     */
    common::Vector3 computeBCrossH(const common::Vector3& h_wheels,
